...
{
    public abstract class HelloLibraryWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HelloLibraryWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HelloLibraryWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HelloLibraryDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HelloLibraryDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HelloLibraryDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HelloLibraryDbContext, Task<T>> func)
        {
            T result;
